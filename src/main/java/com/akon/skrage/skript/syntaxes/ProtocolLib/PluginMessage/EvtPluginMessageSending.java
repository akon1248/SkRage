...
public class EvtPluginMessageSending extends SkriptEvent {
	...
	static {
		Skript.registerEvent("plugin message sending", EvtPluginMessageSending.class, PluginMessageEvent.class, "plugin message send[ing]").description("プラグインメッセージをクライアントから受け取ったときに呼び出されます");
	}
