...
public class EffClientSideGlowing extends Effect {
    ...
    static {
        if (Bukkit.getPluginManager().isPluginEnabled("ProtocolLib")) Skript.registerEffect(EffBlockBreakEffect.class, "make %entities% glow[ing] for %players%", "make %entities% unglow[ing] for %players%");
    }
